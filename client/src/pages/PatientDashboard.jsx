...
import { Calendar, Heart, Pill, AlertCircle } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <Card className="hover:border-blue-500 border-2 border-transparent transition cursor-pointer group shadow-sm">
            <div className="flex gap-4">
              <div className="bg-blue-100 p-3 rounded-xl text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition"><Calendar size={24} /></div>
              <div>
          ...
          <Card className="hover:border-green-500 border-2 border-transparent transition cursor-pointer group shadow-sm">
            <div className="flex gap-4">
              <div className="bg-green-100 p-3 rounded-xl text-green-600 group-hover:bg-green-600 group-hover:text-white transition"><Pill size={24} /></div>
              <div>
          ...
          <Card className="hover:border-red-500 border-2 border-transparent transition cursor-pointer group shadow-sm">
            <div className="flex gap-4">
              <div className="bg-red-100 p-3 rounded-xl text-red-600 group-hover:bg-red-600 group-hover:text-white transition"><Heart size={24} /></div>
              <div>
