...
export const ChatPage = () => {
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'assistant', content: `⚠️ ${errMsg}`, createdAt: new Date().toISOString() }]);
    } finally {
      setLoading(false);
    }
  };
        ...
        <main className="flex-1 md:ml-64 bg-gray-50 min-h-screen">
          <div className="container mx-auto px-4 py-6 max-w-5xl">
            <div className="flex gap-6 h-[calc(100vh-140px)]">
              ...
              <div className="w-64 hidden lg:flex flex-col bg-white rounded-xl shadow-sm border">
                <div className="p-4 border-b">
                  <button
                    onClick={startNewChat}
                    className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg font-medium transition"
                  >
                    ...
                    conversations.map(conv => (
                      ...
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-400 truncate">{conv.lastMessage?.substring(0, 40) || ''}</p>
                        </div>
                        <button
              ...
              <div className="flex-1 flex flex-col bg-white rounded-xl shadow-sm border">
                {/* Header */}
                <div className="p-4 border-b bg-gradient-to-r from-blue-600 to-blue-700 rounded-t-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-xs">Powered by RuralCare Connect</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-amber-50 border-b border-amber-200 px-4 py-2 flex items-center gap-2">
                  ...
                  <p className="text-xs text-amber-700">
                    AI suggestions are not medical diagnosis. Always consult a qualified doctor for medical advice.
                  </p>
                </div>
                  ...
                  {messages.length === 0 && (
                    <div className="flex flex-col items-center justify-center h-full text-center">
                      ...
                      <p className="text-gray-500 max-w-md mb-6">
                        Ask me about symptoms, wellness tips, nutrition, first aid, or general health questions.
                      </p>
                      <div className="grid grid-cols-2 gap-3 max-w-md">
                        {[
                          ...
                          <button
                            ...
                            className="text-left text-sm bg-gray-50 hover:bg-blue-50 hover:text-blue-700 border rounded-lg p-3 transition"
                          >
                            {suggestion}
                          </button>
                        ))}
                ...
                <form onSubmit={handleSend} className="p-4 border-t bg-gray-50 rounded-b-xl">
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white px-5 py-3 rounded-xl transition font-medium flex items-center gap-2"
                    >
                      <Send size={18} />
                    </button>
                  </div>
