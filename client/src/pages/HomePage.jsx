...
export const HomePage = () => {
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section className="bg-gradient2 text-white py-20">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { icon: Clock, title: 'Book Appointments', desc: 'Schedule appointments with qualifi doctors at your convenience' },
        ...
        <section className="bg-gradient-to-r from-blue-600 to-teal-600 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link to="/register" className="inline-block bg-white text-blue-600 px-10 py-4 rounded-lg font-bold hover:bg-gray-100 transition flex items-center gap-2 justify-center">
